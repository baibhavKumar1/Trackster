...
const Explore = () => {
    ...
    let token = useSelector((store) => store.Reducer.token);
    sessionStorage.setItem('token', JSON.stringify(token))
    token = JSON.parse(sessionStorage.getItem('token'))
    const events = useSelector((store) => store.EventReducer.event);
            ...
            <div className=" absolute right-0 w-5/6">
                ...
                <div className="overflow-auto">
                    <div className=' m-2 overflow-y-hidden'>
                        ...
                        <div className='flex gap-5 overflow-x-scroll w-[69em]'>
                            {data.map((item) => {
                                return (
